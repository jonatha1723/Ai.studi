...
import { X, Shield, HardDrive, User, Clock, Trash2, Check, AlertTriangle, EyeOff, DownloadCloud, Lock, Image as ImageIcon, Key, Download, Loader2, Sparkles, ExternalLink, Wrench, RotateCcw } from 'lucide-react';
